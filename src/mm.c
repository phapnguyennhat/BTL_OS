...
int alloc_pages_range(struct pcb_t *caller, int req_pgnum, struct framephy_struct **frm_lst) // Thực hiện ánh xạ số lượng reg_pgnum  vào frame trong memram
{
  ...
  for (pgit = 0; pgit < req_pgnum; pgit++)
  {
    ...
    { // ERROR CODE of obtaining somes but not enough frames
      // Không đủ frame trong ram thực hiên thay trang
      // Nếu hết mswp báo lỗi -3000 hết bộ nhớ
      int vicpgn, swpfpn;
